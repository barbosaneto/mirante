...
curl --fail --location --remote-name https://github.com/barbosaneto/mirante/releases/download/v0.1.3/compose.yml
curl --fail --location --remote-name https://github.com/barbosaneto/mirante/releases/download/v0.1.3/compose.arm64.yml
curl --fail --location --remote-name https://github.com/barbosaneto/mirante/releases/download/v0.1.3/mirante.env.example
curl --fail --location --remote-name https://github.com/barbosaneto/mirante/releases/download/v0.1.3/validate-environment.sh
curl --fail --location --remote-name https://github.com/barbosaneto/mirante/releases/download/v0.1.3/SHA256SUMS
